...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring(
                                'file:/afs/cern.ch/user/y/ykumar/Work/CMSSW_11_0_1/src/Analysis/miniAOD/miniAOD-prod_PAT_8.root'
                            ))
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ggtree_mc_2017_110X_Variable_2.root'))
...
#process.load("/afs/cern.ch/user/y/ykumar/Work/CMSSW_11_0_1/src/ggAnalysis/ggNtuplizer/python/ggNtuplizer_miniAOD_cfi.py")
